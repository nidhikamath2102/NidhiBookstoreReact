...
return(
    <footer className="footer-row">
        <div className="footer-column">
            <ul>
                <Link className="li" to="/">About Us</Link>
                <Link className="li_line" to="/">|</Link>
                <Link className="li" to="/">Contact Us</Link>
                <Link className="li_line" to="/">|</Link>
                <Link className="li" to="/">Directions</Link>
            </ul>
        </div>
        <div className="footer-column">
            <p className="copyright">NK Nobel Novel | All rights reserved © 2024</p>
        </div>
        <div className="footer-column">
            <div  className="social-icons">
                <Link to="/" className="icon_svg">
                ...
                <Link to="/" className="icon_svg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" viewBox="0 0 50 50" width="40" height="40">
                        <path
